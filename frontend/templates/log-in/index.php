        ...
        <div class="main-box">
            <div class="form-box">
                ...
                <form action="index.php" method="POST" id="login" class="input-group">
                    <input type="text" minlength="4" maxlength="20" pattern="[A-Za-z0-9@#$%]+" name="login" class="input-field" placeholder="User id" required>
                    <input type="password" minlength="4" maxlength="20" pattern="[A-Za-z0-9@#$%]+" name="passwd" class="input-field" placeholder="Enter password" required>
                ...
                <form action="index.php" method="POST" id="register" class="input-group">
                    <input type="text" minlength="4" maxlength="20" pattern="[A-Za-z0-9@#$%]+" name="login" class="input-field" placeholder="User id" required>
                    <input type="password" minlength="4" maxlength="20" pattern="[A-Za-z0-9@#$%]+" name="passwd" class="input-field" placeholder="Enter password" required> 
                    <input type="password" minlength="4" maxlength="20" pattern="[A-Za-z0-9@#$%]+" name="chkpassword" class="input-field" placeholder="Confirm password" required>
