            ...
            <div class="forgotpwd-box">
                ...
                <div id="user" style="<?php echo $firststyle?>">
                    <form action="forgot_passwd.php" method="POST" id="userinput" class="input-group" style="top:50px;left:50px">
                        ...
                        <input type="text" minlength="4" maxlength="20" pattern="[A-Za-z0-9@#$%]+" name="login" class="input-field" placeholder="User id" required><br><br><br><br>
                ...
                <div id="newpasswd" style="<?php echo $secondstyle?>">
                    <form action="forgot_passwd.php" method="POST" class="input-group" style="top:50px;left:50px">
                        ...
                        <input type="password" minlength="4" maxlength="20" pattern="[A-Za-z0-9@#$%]+" name="newpwd" class="input-field" placeholder="New password" required>
                        <input type="password" minlength="4" maxlength="20" pattern="[A-Za-z0-9@#$%]+" name="newpwd2" class="input-field" placeholder="New password" required>
